...
async function test_ffmpeg_res(width_test,height_test,stream,test_num)
{
    ...
    width = await capture_test.read_specs("coded_width",test_num);
    height = await capture_test.read_specs("coded_height",test_num);
...
async function test_set_res_fps_DOM(page,i,res)
{
 ...
 (function() {
	...
	module.exports.start_1 = async function(page, test_number) {
            ...
            switch(test_number){
                case "14" : {await test_ffmpeg_res("1920","1080","0","stream1m","14","0"); break;}
                case "15" : {await test_ffmpeg_res("640","368","0","stream2m","14","0"); break;}
                case "16" : {await test_ffmpeg_res("1920","1080","0","stream1","14","0"); break;}
                case "17" : {await test_ffmpeg_res("640","368","0","stream2","14","0"); break;}
